...
int main()
{
    ...
    multiset<string> gmailName; //you don't need to sort the entry, the are alredy sorted
    ...
    for(int a0 = 0; a0 < N; a0++)
    {
        ...
        {
            gmailName.insert(firstName);
        }
    }

    for(auto& elem : gmailName) 
    { 
        cout << elem << endl; 
    }
    return 0;
